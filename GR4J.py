...
class GR4JModel:
    ...
    def test_model(self, run_model):
        ...
        # print('max, min, mean (y_test) = ', max(self.y_test), min(self.y_test), np.mean(self.y_test))
        # print('max, min, mean (preds_gr) = ', max(preds_gr), min(preds_gr), np.mean(preds_gr))
        # print('numérateur NSE : ',np.sum((self.y_test - preds_gr)**2))
        # print('dénominateur NSE : ',np.sum((self.y_test - np.mean(preds_gr))**2))   
        # print('y_test.shape = ',self.y_test.shape) 
        # print('preds_gr.shape = ',preds_gr.shape) 
        # print('shape num : ', (self.y_test - preds_gr).shape)
